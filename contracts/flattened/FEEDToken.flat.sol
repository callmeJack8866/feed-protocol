...
// File contracts/FEEDToken.sol

// Original license: SPDX_License_Identifier: MIT
pragma solidity ^0.8.28;
/**
 * @title FEEDToken
 * @dev BEP-20 浠ｅ竵 鈥?UUPS 鍙崌绾?
 *
 * 鍔熻兘锛?
 * - 鍥哄畾鎬婚噺 10,000,000 鏋?(18 decimals)
 * - 閮ㄧ讲鏃朵竴娆℃€?mint 鍏ㄩ儴缁?owner
 * - 鏀寔閿€姣?(burn) 鐢ㄤ簬濂栨儵绯荤粺
 * - UUPS 浠ｇ悊妯″紡鍙崌绾?
 */
contract FEEDToken is
    ...
    UUPSUpgradeable
{
    /// @notice 鍥哄畾鎬婚噺: 10,000,000 * 10^18
    uint256 public constant MAX_SUPPLY = 10_000_000 * 1e18;

    /// @notice 鏄惁宸插畬鎴愬垵濮嬮摳閫?
    ...
    /**
     * @notice 鍒濆鍖栧嚱鏁帮紙鏇夸唬 constructor锛?
     * @param owner_ 鍚堢害鎵€鏈夎€咃紝鎺ユ敹鍏ㄩ儴鍒濆浠ｅ竵
     */
    ...
    /**
     * @notice 閿€姣佷唬甯侊紙鐢ㄤ簬濂栨儵绯荤粺鐨?10% 閿€姣侊級
     * @param amount 閿€姣佹暟閲?
     */
    ...
    /**
     * @notice 鎺堟潈绗笁鏂归攢姣佷唬甯?
     * @param account 琚攢姣佸湴鍧€
     * @param amount 閿€姣佹暟閲?
     */
