  ...
  return (
    <div className="space-y-12 max-w-7xl mx-auto pb-20 relative">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
        {/* Main Gauges */}
        <div className="lg:col-span-2 p-12 rounded-[4rem] glass-panel border border-white/5 relative overflow-hidden group">
          ...
          <div className="relative z-10 flex flex-col md:flex-row items-center justify-around gap-16">
            <CircularGauge value={profile.accuracyRate} label="Link Accuracy" color="text-cyan-400" size={280} />
            <div className="w-px h-40 bg-white/5 hidden md:block" />
            <CircularGauge value={88} label="Node Integrity" color="text-rose-500" size={280} />
          </div>
        ...
        {/* Sync Stability Card */}
        <div className="p-12 rounded-[4rem] glass-panel border border-white/5 flex flex-col justify-between relative overflow-hidden group">
           ...
           <div className="space-y-6 relative z-10">
              <div className="p-8 rounded-[2.5rem] bg-black/40 border border-white/5 space-y-2">
