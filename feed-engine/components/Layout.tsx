          ...
          <nav className="space-y-4 relative">
            ...
            {menuItems.map((item) => (
              <button
                ...
                className={`w-full text-left px-5 py-5 rounded-[1.8rem] transition-all flex items-center gap-5 font-bold text-sm relative group overflow-hidden ${
              ...
              >
                ...
                <span className="hidden lg:block truncate uppercase tracking-[0.25em] text-[10px] font-black z-10">{item.name}</span>
              </button>
            ))}
          </nav>
        </div>
