        ...
        <div className="p-12 space-y-10">
          <div className="flex justify-between items-start">
            <div className="space-y-1">
              <h2 className="text-3xl font-black font-orbitron tracking-tight text-white uppercase italic">Protocol Filters</h2>
              <p className="text-[10px] text-slate-500 font-black uppercase tracking-[0.2em]">Smart Matching Configuration</p>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
            ...
            <div className="space-y-4">
              <h3 className="text-xs font-black text-cyan-500 uppercase tracking-widest px-2">Jurisdiction Focus</h3>
            ...
            {/* Asset Types Section */}
            <div className="space-y-4">
              <h3 className="text-xs font-black text-purple-500 uppercase tracking-widest px-2">Asset Specialties</h3>
              <div className="flex flex-wrap gap-2">
                {ASSETS.map(a => (
                  <button
                    key={a}
            ...
            <div className="md:col-span-2 space-y-4">
              <h3 className="text-xs font-black text-emerald-500 uppercase tracking-widest px-2">Preferred Gateways (Exchanges)</h3>
              <div className="flex flex-wrap gap-2">
                {EXCHANGES.map(e => (
                  <button
                    key={e}
          ...
          <div className="pt-6 border-t border-white/5 flex flex-col sm:flex-row items-center justify-between gap-6">
            <p className="text-[10px] text-slate-500 font-bold max-w-xs leading-relaxed italic">
              "Your selections influence the smart-matching algorithm. High reputation scores may override some filters for emergency feeds."
            </p>
            <button 
              onClick={onClose}
